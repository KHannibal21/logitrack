      ...
      >
        ...
        <View style={styles.profileHeaderContent}>
          <View style={styles.profileHeaderLeft}>
            ...
            <View>
              <ThemedText style={styles.profileHeaderApp}>{t('profile.title')}</ThemedText>
              <ThemedText style={styles.profileHeaderRole}>{t('role.admin')}</ThemedText>
            </View>
          </View>
          <TouchableOpacity
